...
cmd = ["sphinxdoc", "-v 2", "-p",  installdir, "-n", "consciousnet", "-o", "..",
       "-i", "consciousnet"]
...
project = u"consciousnet"
copyright = u"""{0}, consciousnet developers <antoine.grigis@cea.fr>""".format(
...
html_title = "consciousnet"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "consciousnet"
...
htmlhelp_basename = "consciousnet"
...
# [howto/manual]).
latex_documents = [
    ("index", "consciousnet.tex", "consciousnet Documentation", """consciousnet developers""",
     "manual"),
]
